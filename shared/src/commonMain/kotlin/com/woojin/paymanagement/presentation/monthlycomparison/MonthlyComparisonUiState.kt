...
data class MonthlyComparisonUiState(
    ...
    val savingCategoryComparisons: List<CategoryComparison> = emptyList(),
    val totalCurrentSaving: Double = 0.0,
    val totalPreviousSaving: Double = 0.0,
    val totalSavingDifference: Double = 0.0,
    val totalSavingDifferencePercentage: Float = 0f,
    val investmentCategoryComparisons: List<CategoryComparison> = emptyList(),
    val totalCurrentInvestment: Double = 0.0,
    val totalPreviousInvestment: Double = 0.0,
    val totalInvestmentDifference: Double = 0.0,
    val totalInvestmentDifferencePercentage: Float = 0f,
